...
const STARTER_VOCAB = {
  en: [ // English
    { en: "rennen", target: "to run", category: "verbs", image: "run" },
    { en: "sprechen", target: "to speak", category: "verbs", image: "speak" },
    { en: "lernen", target: "to learn", category: "verbs", image: "book" },
    { en: "Apfel", target: "apple", category: "nouns", image: "apple" },
    { en: "Brot", target: "bread", category: "nouns", image: "bread" },
    { en: "Computer", target: "computer", category: "technology", image: "computer" },
    { en: "Datenbank", target: "database", category: "technology", image: "database" },
    { en: "Zelle", target: "cell", category: "biology", image: "cell" },
    { en: "Organismus", target: "organism", category: "biology", image: "organism" },
    { en: "Wie geht es dir?", target: "how are you?", category: "phrases", image: "conversation" }
  ],
  de: [ // German
    { en: "to run", target: "rennen", category: "verbs", image: "run" },
    { en: "to speak", target: "sprechen", category: "verbs", image: "speak" },
    { en: "to learn", target: "lernen", category: "verbs", image: "book" },
    { en: "apple", target: "Apfel", category: "nouns", image: "apple" },
    { en: "bread", target: "Brot", category: "nouns", image: "bread" },
    { en: "computer", target: "Computer", category: "technology", image: "computer" },
    { en: "database", target: "Datenbank", category: "technology", image: "database" },
    { en: "cell", target: "Zelle", category: "biology", image: "cell" },
    { en: "organism", target: "Organismus", category: "biology", image: "organism" },
    { en: "How are you?", target: "Wie geht es dir?", category: "phrases", image: "conversation" }
  ],
  it: [ // Italiano
    { en: "to run", target: "correre", category: "verbs", image: "run" },
    { en: "to speak", target: "parlare", category: "verbs", image: "speak" },
    { en: "to learn", target: "imparare", category: "verbs", image: "book" },
    { en: "apple", target: "mela", category: "nouns", image: "apple" },
    { en: "bread", target: "pane", category: "nouns", image: "bread" },
    { en: "computer", target: "computer", category: "technology", image: "computer" },
    { en: "database", target: "database", category: "technology", image: "database" },
    { en: "cell", target: "cellula", category: "biology", image: "cell" },
    { en: "organism", target: "organismo", category: "biology", image: "organism" },
    { en: "How are you?", target: "Come stai?", category: "phrases", image: "conversation" }
  ],
  es: [ // Spanish
    { en: "to run", target: "correr", category: "verbs", image: "run" },
    { en: "to speak", target: "hablar", category: "verbs", image: "speak" },
    { en: "to learn", target: "aprender", category: "verbs", image: "book" },
    { en: "apple", target: "manzana", category: "nouns", image: "apple" },
    { en: "bread", target: "pan", category: "nouns", image: "bread" },
    { en: "computer", target: "computadora", category: "technology", image: "computer" },
    { en: "database", target: "base de datos", category: "technology", image: "database" },
    { en: "cell", target: "célula", category: "biology", image: "cell" },
    { en: "organism", target: "organismo", category: "biology", image: "organism" },
    { en: "How are you?", target: "¿Cómo estás?", category: "phrases", image: "conversation" }
  ],
  fr: [ // French
    { en: "to run", target: "courir", category: "verbs", image: "run" },
    { en: "to speak", target: "parler", category: "verbs", image: "speak" },
    { en: "to learn", target: "apprendre", category: "verbs", image: "book" },
    { en: "apple", target: "pomme", category: "nouns", image: "apple" },
    { en: "bread", target: "pain", category: "nouns", image: "bread" },
    { en: "computer", target: "ordinateur", category: "technology", image: "computer" },
    { en: "database", target: "base de données", category: "technology", image: "database" },
    { en: "cell", target: "cellule", category: "biology", image: "cell" },
    { en: "organism", target: "organisme", category: "biology", image: "organism" },
    { en: "How are you?", target: "Comment ça va?", category: "phrases", image: "conversation" }
  ]
};
